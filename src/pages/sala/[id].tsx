...
import { ArrowArcLeftIcon, RobotIcon, PencilSimpleIcon, UsersIcon } from "@phosphor-icons/react";
    ...
    <Layout>
      <div className="max-w-6xl mx-auto p-6">
        <div className="mb-8">
          ...
          <p className="text-gray-500 text-lg">{room?.description || "Carregando descrição..."}</p>
        </div>
                ...
                {messages.map((msg) => (
                  ...
                  >
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      {msg.isAI && <RobotIcon className="w-4 h-4 text-blue-600" />}
                    </div>
                    <p>{msg.content}</p>
                  </div>
                ))}
